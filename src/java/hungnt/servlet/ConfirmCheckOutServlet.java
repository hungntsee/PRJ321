...
public class ConfirmCheckOutServlet extends HttpServlet {
    private final String PROCESS_CONFIRM_CHECK_OUT_SERVLET = "ProcessConfirmCheckOut";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            if( action.equals("Confirm") ){
                url = roadMap.get(PROCESS_CONFIRM_CHECK_OUT_SERVLET);
                //System.out.println("ConfirmCheckOutServlet confirm action");
